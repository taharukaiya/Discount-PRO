        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1" data-aos="fade-right">
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center border border-gray-100">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Taha Rukaiya</h2>
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* About Me */}
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100" data-aos="fade-left">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                ...
                I love creating user-friendly applications that solve real-world problems and provide excellent 
                user experiences. My journey in web development started with curiosity and has evolved into 
            ...
            {/* Technical Skills */}
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100" data-aos="fade-left" data-aos-delay="200">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 mb-3">Backend & Tools</h4>
                  <div className="space-y-2">
                    {[
        ...
        <div className="mt-16" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Discount PRO",
                description: "A comprehensive coupon collecting application with Firebase authentication",
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow">
                <div className={`w-full h-32 bg-gradient-to-r ${project.color} rounded-lg mb-4 flex items-center justify-center text-white text-2xl font-bold`}>
